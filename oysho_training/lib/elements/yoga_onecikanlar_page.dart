...
class YogaOnecikanPage extends StatefulWidget {
  const YogaOnecikanPage({Key? key}) : super(key: key);

  @override
  State<YogaOnecikanPage> createState() => _YogaOnecikanPageState();
}

class _YogaOnecikanPageState extends State<YogaOnecikanPage> {
  int _current = 0;
