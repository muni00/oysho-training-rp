...
class FitnesOnecikanPage extends StatefulWidget {
  const FitnesOnecikanPage({Key? key}) : super(key: key);

  @override
  State<FitnesOnecikanPage> createState() => _FitnesOnecikanPageState();
}

class _FitnesOnecikanPageState extends State<FitnesOnecikanPage> {
  int _current = 0;
